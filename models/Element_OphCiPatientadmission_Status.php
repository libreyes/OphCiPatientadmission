...
class Element_OphCiPatientadmission_Status extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophcipatientadmission_status';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'status' => array(self::BELONGS_TO, 'OphCiPatientadmission_Status', 'status_id'),
		);
	}
