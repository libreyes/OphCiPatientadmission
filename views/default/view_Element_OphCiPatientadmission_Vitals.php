...
?>
	<div class="element-data">
		...
		<div class="row data-row">
			...
			<div class="large-9 column end"><div class="data-value"><?php echo $element->blood_glucose_na ? 'N/A' : ($element->blood_glucose_m ? $element->blood_glucose_m->getValueText() : 'Not recorded')?></div></div>
		</div>
	</div>
