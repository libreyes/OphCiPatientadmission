...
<table class="subtleWhite normalText">
	<tbody>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('patient_id_verified'))?></td>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('caregiver_name'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->caregiver_name)?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('caregiver_relationship_id'))?></td>
			<td><span class="big"><?php echo $element->caregiver_relationship ? $element->caregiver_relationship->name : 'None'?></span></td>
		</tr>
	</tbody>
</table>
